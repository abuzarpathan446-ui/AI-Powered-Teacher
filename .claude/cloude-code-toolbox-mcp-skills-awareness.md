...
_Generated: 2026-09-04T16:27:25.818Z_
...
Workspace `mcp.json` _(folder: power-teacher)_

- **c:\AI innovatin H\power-teacher\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\ABUZAR PATHAN\.claude.json** — _File exists — no servers defined_
